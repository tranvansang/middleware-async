...
export var asyncMiddleware = function (middleware) { return function (req, res, next) { return (function () {
    var called = false;
    var cb = function () {
        var args = [];
 ...
 * @returns {Function}
 */
export var combineMiddlewares = function (first) {
    var _a;
    var middlewares = [];
    ...
    return function (req, res, next) { return first
        ? first(req, res, function (err) { return err
            ? next(err)
            : combineMiddlewares.apply(void 0, middlewares)(req, res, next); })
        : next(); };
};
var expressMajorVersion = 4;
export var mockExpressMajorVersion = function (v) { return expressMajorVersion = v; };
/**
 ...
 */
export var middlewareToPromise = function (middleware) { return function (req, res) { return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
 ...
 * @param args
 */
export var combineToAsync = function () {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
